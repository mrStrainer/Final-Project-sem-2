	...
	public void Initialize()
	{
		...
		btnMemory.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					item.insertMemory(name, price, sPrice, stock, brand, description, size, type);
				} catch (Exception e) {
		...
		btnPrinter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ItemControl item = new ItemControl();
				try {
					item.insertPrinter(name, price, sPrice, stock, brand, description, type, size);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
		...
		btnCamera.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ItemControl item = new ItemControl();
				try {
					item.insertCamera(name, price, sPrice, stock, brand, description, type, resolution);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
		...
		btnPhone.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ItemControl item = new ItemControl();
				try {
					item.insertPhone(name, price, sPrice, stock, brand, description, RAM, scrSize);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
		...
		btnCopier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ItemControl item = new ItemControl();
				try {
					item.insertCopier(name, price, sPrice, stock, brand, description, type, speed);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
		...
		btnOther.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ItemControl item = new ItemControl();
				try {
					item.insertOther(name, price, sPrice, stock, brand, description);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
		...
		btnCustomer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String phone1 = textField_5.getText();
				int phone = Integer.parseInt(phone1);
				String bDay1 = textField_4.getText();
				int bDay = Integer.parseInt(bDay1);
				PersonControl pc = new PersonControl();
				try {
					pc.insertCustomer(fName, lName, email, address, phone, bDay);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
		...
		btnEmployee.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonControl pc = new PersonControl();
				try {
					pc.insertEmployee(fName, lName, email, address, phone, bDay);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
		...
		btnSupplier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonControl pc = new PersonControl();
				try {
					pc.insertSupplier(fName, lName, email, address, phone, bDay);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
